...
describe('Round', function() {
  ...
  //it should take in responses and records these guesses (turn)

  //the `currentCard` should be the first `Card` in the `Deck` at the start of  `Round`
  // property of currentCard should be the first card this.cards[Deck]
});
